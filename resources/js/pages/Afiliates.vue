                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-chart-1 text-white dark:bg-chart-1">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Nivell</th>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Comissió %
                                </th>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Reserves
                                </th>
                                <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider">Guanyat (€)
                                </th>
                        ...
                        <tbody>
                            <tr v-for="afiliat in filteredList" :key="afiliat.id"
                                ...
                                <td class="px-4 py-2 flex items-center">
                                    <button @click="deleteAfiliat(afiliat)" class="text-chart-5 px-3 py-1 rounded">
